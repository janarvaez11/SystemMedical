	...
	private function _get_combo_db_unique_ordered($table, $field, $label, $orderField, $selectedValue = "")
{
					...
					<br>
  					<table class="table table-bordered table-striped mx-auto">
						...
						<tbody>
							<tr>
								<td>Id Usuario:</td>
								<td>' . $this->_get_combo_db_unique_ordered("usuarios", "IdUsuario", "IdUsuario", "IdUsuario", $this->IdUsuario) . '</td>
								</tr>
							<tr>
								<td>Nombre:</td>
	...
	public function get_list()
	{
		...
		$sql = "SELECT IdPaciente, IdUsuario, Nombre, Cedula, Edad, Genero, Estatura, Peso FROM pacientes;";
		$res = $this->con->query($sql);
