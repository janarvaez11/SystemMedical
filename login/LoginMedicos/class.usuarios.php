	...
	function __construct($cn){
		...
		public function bienvenida_usuario(){
			...
			if ($Rol == 1) {
				...
				// Si el rol es 2 (Medico), mostrar un mensaje de bienvenida personalizado y redirigir.
				echo "<script>alert('Bienvenido Medico $this->Nombre');";
				echo "window.location.href = '../../Medico/index.html';";
				echo "</script>";
				exit;
